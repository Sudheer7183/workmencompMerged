...
export const MOCK_CARRIERS = [
  { carrier_id: 1, carrier_name: "State Farm", name: "State Farm", slug: "state-farm", ai_narrative_enabled: true },
  { carrier_id: 2, carrier_name: "Travelers",  name: "Travelers",  slug: "travelers",  ai_narrative_enabled: false },
];
...
const phase2Handlers = [
  ...
  http.post("/platform/carriers", () =>
    HttpResponse.json({ carrier_id: 99, carrier_name: "New Carrier", slug: "new-carrier", ai_narrative_enabled: false }, { status: 201 })
  ),
];
...
afterEach(() => {
  ...
  cleanup(); // unmount components and clear DOM between tests
});
