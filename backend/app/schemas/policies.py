...
class PolicyMetaCard(BaseModel):
    ...
    premium_written:    Optional[Decimal] = None


class NarrativeData(BaseModel):
    """Narrative data embedded in PolicyDetailResponse."""

    text: str
    is_fallback: bool
    provider: Optional[str] = None
    generated_at: Optional[str] = None
    engine_was_off: bool = False
    not_attempted: bool = False


class PolicyDetailResponse(BaseModel):
    """Full Policy Detail screen response — meta card + engine_on flag + narrative."""
