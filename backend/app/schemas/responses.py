...
class AuditRunRequest(BaseModel):
    ...
    # For display_only bulk sessions: ALL run_ids from the session.
    # When provided, narrative generation aggregates data across every run
    # in this list and calls the LLM exactly once per unique policy.
    # Empty list = single-run mode (default, calc_engine behaviour unchanged).
    bulk_run_ids: list[int] = []
