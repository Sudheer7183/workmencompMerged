...
#     # Payroll detail (Bakeland/Yoders style)
...
#     "estimatedpremiumtoenddat":  "est_premium_end",
#     "estimatedpremiumtoend":     "est_premium_end",
#     "variance":                  "actual_premium",
#     # PR Var sheet
#     "insured":                   "insured_name",
#     "carrier":                   "insured_name",   # carrier column exists but we skip it
...
#     "policyeffdate":             "effective_date",
#     "policyexpdate":             "expiration_date",
#     "carriername":               "insured_name",   # skip
#     "checkdate":                 "expected_period_start",
...
#     "exposurereceived":          "exposure",
#     "exposurereceip":            "exposure",
#     "exposureassessed":          "actual_payroll_reported",
#     "netrateper":                "net_rate",
#     "employeecount":             "notice_instance",
#     # XML field display names
#     "policynumberxml":           "policy_number",
#     "insuredname":               "insured_name",
#     "fein":                      "fein",
#     "effectivedate":             "effective_date",
...
#             # Insured name is in column B of row 3
#             if len(cells) >= 2:
#                 row_text = str(all_rows[2][0] or "")
#                 if "Date Report Run:" in row_text:
#                     insured = str(all_rows[2][1] or "").strip() if len(all_rows[2]) > 1 else ""
#                     if insured:
